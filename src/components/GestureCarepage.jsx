    ...
    <div id="start" className="gc3-container">
      ...
      <section className="gc3-hero">
        <div className="gc3-hero-content">
          ...
          <p>
            A smart healthcare communication platform that combines artificial
            intelligence, computer vision, and wearable sensing to enable
            reliable patient–caregiver interaction in clinical and assisted-care
            environments.
          </p>

          <div className="gc3-hero-buttons">
            <a
              href="https://drive.google.com/file/d/1hkFqySeEZwQCm5bzBhfdFMONbMqvC-iV/view?usp=sharinghttps://drive.google.com/file/d/1hkFqySeEZwQCm5bzBhfdFMONbMqvC-iV/view?usp=sharing"
              target="_blank"
      ...
      <section className="gc3-top-grid">
        <div className="gc3-box">
          ...
          <p>
            The system establishes a natural gesture-based communication
            interface for patients who face physical or cognitive communication
            barriers, enabling dignified and accessible interaction in
            healthcare environments.
          </p>
          <p>
            The bimodal architecture ensures reliability, fault tolerance, and
        ...
        <div className="gc3-box">
          ...
          <p>
            Universal accessibility, clinical reliability, real-time response,
            system resilience, and scalable deployment form the foundation of
            the platform design philosophy.
          </p>
          <p>
            The system prioritizes patient dignity, safety, and long-term
      ...
      <section className="gc3-team">
        ...
        <p className="gc3-team-members">
          Sadhana Tiwari · Ritesh Chandra · Tanisha · Prableen Kaur · Swarup
          Narkhede · Shravani Wange · Pratik Pansare
        </p>
        <p className="gc3-guide">
