  ...
  return (
    <section className="projects-container">
      ...
      <div className="project-list">
        {(activeTab === "ongoing" ? Ongoingprojects : Completedprojects).map(
          (proj) => (
            <div className="project-card" key={proj.id}>
              ...
              <div className="project-details">
                <p>
                  <strong>Funding Agency:</strong> {proj.agency || "N/A"}
                </p>
                {proj.scheme && (
                  <p>
                    <strong>Scheme:</strong> {proj.scheme}
                  </p>
                )}
                {proj.brief && (
              ...
              {proj.website && proj.website !== "" && (
                <a
                  href={proj.website} // Ab ye "/#/csir" uthayega
                  target="_blank"
                  rel="noreferrer"
