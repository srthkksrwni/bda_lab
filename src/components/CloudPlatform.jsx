  ...
  return (
    <div className="hm-card">
      ...
      <div className="hm-objectives">
        ...
        <ul>
          <li>
            Enable scalable data analytics using Kafka, Hadoop, and Spark ML
          </li>
          <li>
            Analyze multimodal sensor data streams through complex event
            processing
          </li>
          <li>Detect anomalies and composite risk situations in real time</li>
          <li>
            Personalize interventions and alerts using adaptive reinforcement
            learning
          </li>
          <li>Support both medical and psychological emergency detection</li>
          <li>
            Integrate low-latency edge responses with cloud-level predictive
            intelligence
          </li>
        </ul>
      </div>
